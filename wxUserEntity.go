...
type WxUserEntity struct {
	...
	MemberId int64     `json:"member_id" xorm:"default 0 index"`
	OpenId   string    `json:"open_id" xorm:"varchar(100) default '' index"`
	UnionId  string    `json:"union_id" xorm:"varchar(100) default '' index"`
	NickName string    `json:"nickName" xorm:"varchar(100) defult ''"`
	Gender   int       `json:"gender"` // 1男，2女， 0未知
